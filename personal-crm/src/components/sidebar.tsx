...
const navItems = [
  ...
  { href: '/contacts/new', label: 'Add Contact', icon: AddIcon },
];
    ...
    <aside className="fixed left-0 top-0 h-full w-60 bg-surface border-r border-border flex flex-col z-50">
      <div className="p-5 border-b border-border">
        <h1 className="text-lg font-semibold text-foreground tracking-tight">
          <span className="text-accent">●</span> Personal CRM
        </h1>
        <p className="text-xs text-muted mt-0.5">Andrew&apos;s Network</p>
      </div>
...
function CommandCenterIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
